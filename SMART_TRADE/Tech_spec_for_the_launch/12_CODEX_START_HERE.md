...
С этого момента пакет считается закрывающим Codex blockers на `100%`, за исключением реальных секретов/URL/путей, которые пользователь вставляет только в своей среде.
